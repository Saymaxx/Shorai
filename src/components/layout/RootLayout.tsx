...
export default function RootLayout({ children }: RootLayoutProps) {
  return (
    <main className="flex min-h-screen min-h-[100dvh] flex-col bg-background selection:bg-primary/30 selection:text-primary relative transition-colors duration-300">
      ...
      >
        <span 
          className="font-black uppercase tracking-tighter text-transparent bg-clip-text bg-gradient-to-b from-[#00D4FF]/35 via-[#7928CA]/25 to-[#00D4FF]/20 dark:from-[#00D4FF]/40 dark:via-[#7928CA]/30 dark:to-[#00D4FF]/22 leading-none select-none"
          style={{ 
