...
export default function HeroVisual({ activeSection = 'hero' }: HeroVisualProps) {
  ...
  return (
    <div
      className="relative w-full h-full min-h-[300px] sm:min-h-[420px] lg:min-h-[640px] flex items-center justify-center pointer-events-auto select-none overflow-visible"
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none" aria-hidden="true">
        ...
        <motion.div
          className="w-[290px] sm:w-[420px] lg:w-[560px] h-[290px] sm:h-[420px] lg:h-[560px] rounded-full border border-primary/20 border-dashed"
          animate={{ rotate: 360 }}
          transition={{ duration: 40, repeat: Infinity, ease: 'linear' }}
        />
        {/* Middle reverse rotating tech ring with tick markers */}
        <motion.div
          className="absolute w-[220px] sm:w-[320px] lg:w-[440px] h-[220px] sm:h-[320px] lg:h-[440px] rounded-full border border-secondary/25 border-dotted"
          animate={{ rotate: -360, scale: [1, 1.04, 1] }}
          transition={{ duration: 30, repeat: Infinity, ease: 'easeInOut' }}
        />
        {/* Inner pulsing energetic glow sphere */}
        <motion.div
          className="absolute w-[160px] sm:w-[240px] lg:w-[320px] h-[160px] sm:h-[240px] lg:h-[320px] rounded-full bg-gradient-to-tr from-primary/10 via-secondary/15 to-transparent blur-[40px] sm:blur-[50px]"
